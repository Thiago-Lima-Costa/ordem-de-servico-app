...
export default function CadastrarReceitaScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Cadastrar Receita</Text>
      ...
      <Button title="Salvar Receita" onPress={handleSalvar} />
    </View>
  );
}
